sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.aunaCopyCopyCopy.controller.Dialog2", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.aunaCopyCopyCopy.view.Dialog2", this);
			this._bInit = false;
		},
		...
		_onNotificationListItemClose2: function(oEvent) {
			var oCtrl = oEvent.getSource();
			var oParent = oCtrl.getParent();
			if (oParent instanceof sap.m.NotificationListGroup || oParent['removeItem']) {
				oParent.removeItem(oCtrl);
